...
function Details() {
  ...
  if (!movie)
    return (
      <p className=" flex_center h-screen bg-black ">
        Loading...
      </p>
    );

  return (
    <div className="p-4 flex-center flex-col  text-white bg-black h-screen  ">
    ...
    <div className="mx-4">
      ...
      <button onClick={handlFavorite} className="bg-zinc-400 p-3 rounded-3xl">
        {" "}
